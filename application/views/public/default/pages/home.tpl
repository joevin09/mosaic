        ...
        <{if ($this->user->agency_name == NULL)}>
            <div id="postulant" class="content visible-menu">
                <div class="pres pres_postulant">
                    ...
                    <h3 class="h3-home"><span>Tu cherches <br/><span id="changeword-postulant">ta place</span><br/> sur le web ?</h3>
                ...
                <div class="img_post hidden-xs hidden-sm">
                    ...
                    <h4 class="my_h4">Dernières agences.</h4>
                </div>
                <div class="last_register_home">
                    <ul class="list">
                        <{$i = 0}>
        ...
        <{else}>
            <div id="agency" class="content">
                ...
                <div class="img_post hidden-xs hidden-sm">
                    ...
                    <h4 class="my_h4">Derniers postulants.</h4>
                </div>
                <div class="last_register_home">
                    <ul class="list">
                        <{$i = 0}>
