<{if count($list) > 0}>
    <div class="pres pres-register membres">
        ...
        <h2><{$this->user->first_name}></h2>
        <h3 class="clear">Ta mosaic d'agences</h3>
        ...
        <{/if}>
        <a class="padding-bottom ecra-bread" href="<{site_url('search_agency')}>">Recherche</a>
    </div>
    ...
    <div class="img_post membres-img hidden-xs hidden-sm">
        ...
        <h4 class="my_h4 move_h for-all move-h-mosaic-agency">Agences correspondantes.</h4>
    </div>
...
<{else}>
    ...
    <div class="img_post membres-img hidden-xs hidden-sm">
        <img src="<{assets('img/img_search.jpg')}>" alt="Image d'un contact">
        <h4 class="my_h4 move_h for-all move-all-h-mosaic">Toutes les agences.</h4>
    </div>
    <div class="last_register_home all-members">
        <ul class="list">
