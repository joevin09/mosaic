<style type="text/css">
    ...
    h1, h2, h3, h4, h5, h6 { line-height: 100% !important; -webkit-font-smoothing: antialiased; color: #A30234; }
    h1 a, h2 a, h3 a, h4 a, h5 a, h6 a { color: <{$color1}> !important; }
    h1 a:active, h2 a:active,  h3 a:active, h4 a:active, h5 a:active, h6 a:active {	color: red !important; }
    /* Preferably not the same color as the normal header link color.  There is limited support for psuedo classes in email clients, this was added just for good measure. */
    h1 a:visited, h2 a:visited,  h3 a:visited, h4 a:visited, h5 a:visited, h6 a:visited { color: purple !important; }
    h1 span { color: #323A45; }
    /* Preferably not the same color as the normal header link color. There is limited support for psuedo classes in email clients, this was added just for good measure. */  
    ...
    /* Webkit Elements */
    #top-bar { border-radius:6px 6px 0px 0px; -moz-border-radius: 6px 6px 0px 0px; -webkit-border-radius:6px 6px 0px 0px; -webkit-font-smoothing: antialiased; background-color: <{$color1}>; color: #d9fffd; }
    ...
    #footer { background-color: <{$color2}>; color: #d9fffd; }
    #footer a { color: #F0F0F0 !important; text-decoration: none; font-weight: bold; }
    #permission-reminder { white-space: normal; }
    #street-address { color: #d9fffd; white-space: normal; }
    .price { font-size: 18px; font-weight: bold; text-align: right; color: #A30234; }
    hr { border: 0; border-top: 1px solid #F0F0F0; margin-top: 20px; margin-bottom: 20px; }
    repeater a { color: <{$color1}>; }
    /*]]>*/
</style>
<!--[if gte mso 9]>
<style _tmplitem="40">
