<style type="text/css">
    ...
    #codeigniter-profiler .label { color: #fff; }
    ...
    #ci-profiler-menu-open:hover { text-decoration: none; }
...
<script type="text/javascript">
    var ci_profiler_bar = {
        ...
        nberrors: <?php echo $sections['console']['error_count'] ?>,
        ...
        set_load_state : function() {
            ...
            if (cookie_state == 'open' || this.nberrors > 0) {
                this.open();
            } else {
                this.close();
            }
    ...
    <div id="ci-profiler-menu">
        ...
        <?php if (isset($sections['console'])) : ?>
            <a href="#" id="ci-profiler-menu-console" onclick="ci_profiler_bar.show('ci-profiler-console', 'ci-profiler-menu-console'); return false;">
                <?php if (!$sections['console']['error_count']) : ?>
                    <span><?php echo is_array($sections['console']) ? $sections['console']['log_count'] + $sections['console']['memory_count'] : 0 ?></span>
                    Console
                <?php else : ?>
                    <span><?php echo is_array($sections['console']) ? $sections['console']['error_count'] : 0 ?></span>
                    <span class="label label-important">ERROR<?php if ($sections['console']['error_count'] > 1) echo "S"; ?></span>
                <?php endif; ?>
            </a>
        <?php endif; ?>
        ...
        <a href="#" id="ci-profiler-menu-exit" onclick="ci_profiler_bar.close(); return false;" style="width: 2em; height: 2em"></a>
    </div>
                    ...
                    <table class="main">
                        <?php foreach ($sections['console']['console'] as $log) : ?>
                            ...
                            <?php elseif ($log['type'] == 'error') : ?>
                                <tr>
                                    <td><span class="label label-important"><?php echo $log['type'] ?></span></td>
